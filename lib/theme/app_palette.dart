...
class AppPalette extends ThemeExtension<AppPalette> {
  ...
  static const light = AppPalette(
    ...
    mapMarkerLightStart: Color(0xFF7E93DE),
    mapMarkerLightEnd: Color(0xFF6078C8),
    mapMarkerLightSelectedStart: Color(0xFF617CFF),
    mapMarkerDarkStart: Color(0xFF4F68A7),
    mapMarkerDarkEnd: Color(0xFF344A82),
  ...
  static const dark = AppPalette(
    bg: Color(0xFF07111F),
    surface: Color(0xFF0E1B31),
    surfaceSoft: Color(0xFF13233D),
    surfaceMuted: Color(0xFF1B315A),
    border: Color(0xFF223A64),
    textPrimary: Color(0xFFF3F7FF),
    textSecondary: Color(0xFFB4C2E0),
    textTertiary: Color(0xFF7F93B7),
    primary: Color(0xFF5B73FF),
    primarySoft: Color(0xFF223A78),
    primaryStrong: Color(0xFF7C90FF),
    icon: Color(0xFFF3F7FF),
    shadow: Color(0x33000000),
    scrim: Color(0x1F000000),
    modalBarrier: Color(0x26000000),
    bottomSheetSurface: Color(0xFF12233D),
    bottomSheetInnerSurface: Color(0xFF162845),
    bottomSheetBorder: Color(0xFF263E67),
    bottomSheetChipSurface: Color(0xFF20375E),
    bottomSheetChipBorder: Color(0xFF4B6DA8),
    mapMarkerLightStart: Color(0xFF7E93DE),
    mapMarkerLightEnd: Color(0xFF6078C8),
    mapMarkerLightSelectedStart: Color(0xFF617CFF),
    mapMarkerDarkStart: Color(0xFF4F68A7),
